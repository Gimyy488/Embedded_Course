...
#define TIMER0_WAVEFORM_GEN_MODE_PWM            1
#define TIMER0_WAVEFORM_GEN_MODE_CTC            2
#define TIMER0_WAVEFORM_GEN_MODE_FASTPWM        3
...
static ES_t enuCalculateOVFNOCR(u8 Copy_u8IntPin , u16 Copy_u16DelayTime);
